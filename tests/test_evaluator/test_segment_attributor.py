...
def sample_nodes():
    return [
        TextNode(text="Photosynthesis is the process by which green plants use sunlight to make food."),
...
def test_locate_segments_output_structure(attributor, sample_query, sample_response, sample_nodes):
...
def test_evaluate_compatibility(attributor, sample_query, sample_response, sample_nodes):
