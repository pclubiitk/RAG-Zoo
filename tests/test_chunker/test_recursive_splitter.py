...
def test_chunking_with_metadata(sample_docs, sample_metadata):
    ...
    assert any("doc1" in chunk or "001" in chunk for chunk in chunks), "doc1 metadata missing"
    assert any("doc2" in chunk or "002" in chunk for chunk in chunks), "doc2 metadata missing"
